<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageNotPublic.master" AutoEventWireup="true" CodeFile="NonProfitEditProfile.aspx.cs" Inherits="NonProfitEditProfile" %>
...
<p>
        ...
        <%--יש להכניס את כל שדות עריכת עמותה--%>
        <%--יש לעדכן מאמתים--%>
